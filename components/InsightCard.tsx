...
export default function InsightCard({
  ...
  return (
    <div
      onClick={onClick}
      className="bg-[#181818] rounded-lg text-white p-6 min-w-[400px] max-w-[400px] cursor-pointer transition-all duration-200 hover:brightness-110 flex flex-col gap-3"
    >
